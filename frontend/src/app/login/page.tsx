  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col px-6 py-8">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-3xl font-black text-dark-text mb-2">С возвращением! 👋</h1>
          <p className="text-warm-gray text-sm">Войдите в свой аккаунт, чтобы продолжить</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-end pt-1">
            <Link href="#" className="text-xs font-bold text-sage-dark hover:underline">
              Забыли пароль?
            </Link>
          </div>
          ...
          <button
            ...
            className="w-full bg-sage text-white font-bold py-4 rounded-2xl mt-4 disabled:opacity-50 hover:bg-sage-dark transition shadow-warm active:scale-[0.98]"
          >
        ...
        <p className="text-center text-sm text-warm-gray mt-8 font-medium">
          Нет аккаунта?{' '}
          <Link href="/register" className="text-sage-dark font-bold hover:underline">
            Зарегистрироваться
          </Link>
        </p>
      </div>
